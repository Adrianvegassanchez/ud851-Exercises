...
public class VisualizerActivity extends AppCompatActivity {
    ...
    // TODODONE (1) Change the name of default setup to setupSharedPreferences
    private void setupSharedPreferences() {
        // TODODONE (2) Get a reference to the default shared preferences from the PreferenceManager class
        // TODODONE (3) Get the value of the show_bass checkbox preference and use it to call setShowBass
