...
// TODODONE(1) Implement OnSharedPreferenceChangeListener
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener{
    ...
    private void setupSharedPreferences() {
        ...
        // TODODONE (3) Register the listener
        sharedPreferences.registerOnSharedPreferenceChangeListener(this);
    }

    // TODODONE (2) Override the onSharedPreferenceChanged method and update the show bass preference
    // TODODONE (4) Override onDestroy and unregister the listener
