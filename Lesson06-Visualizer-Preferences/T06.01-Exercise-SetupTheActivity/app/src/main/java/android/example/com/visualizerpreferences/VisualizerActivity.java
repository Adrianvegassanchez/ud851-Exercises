...
public class VisualizerActivity extends AppCompatActivity {
    ...
    // TODODONE (1) Create a new Empty Activity named SettingsActivity; make sure to generate the
    // activity_settings.xml layout file as well and add the activity to the manifest

    // TODODONE (2) Add a new resource folder called menu and create visualizer_menu.xml
    // TODODONE (3) In visualizer_menu.xml create a menu item with a single item. The id should be
    ...
    // TODODONE (5) Add the menu to the menu bar
    // TODODONE (6) When the "Settings" menu item is pressed, open SettingsActivity
}