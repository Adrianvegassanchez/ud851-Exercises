    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDoSomethingCoolButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // TODODONE (1) Store ChildActivity.class in a Class object called destinationActivity
                Class destinationActivity = ChildActivity.class;
                // TODODONE (2) Create an Intent to start ChildActivity
                Intent intent = new Intent(context, destinationActivity);
                // TODODONE (3) Replace the Toast with code to start ChildActivity
