...
// TODODONE (1) Use Android Studio's Activity wizard to create a new Activity called ChildActivity

// Do steps 2 - 5 in activity_child.xml
// TODODONE (2) Change the ConstraintLayout to a FrameLayout and make appropriate adjustments
// TODODONE (3) Give your TextView an ID of tv_display
// TODODONE (4) Set the text to something that indicates this is default text being displayed
// TODODONE (5) Make the text size a little larger

// Do steps 6 & 7 in ChildActivity.java
// TODODONE (6) Create a TextView field to display your message
// TODODONE (7) Get a reference to your TextView in Java