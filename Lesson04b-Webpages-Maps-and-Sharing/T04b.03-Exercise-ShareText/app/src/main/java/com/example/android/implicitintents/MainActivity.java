...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        // TODODONE (5) Specify a String you'd like to share
        String textToShare = "Hey im sharing";
        // TODODONE (6) Replace the Toast with shareText, passing in the String from step 5
        //Toast.makeText(this, "TODODONE: Share text when this is clicked", Toast.LENGTH_LONG).show();
    ...
    // TODODONE (1) Create a void method called shareText that accepts a String as a parameter
    // Do steps 2 - 4 within the shareText method
    void shareText(String text) {
        // TODODONE (2) Create a String variable called mimeType and set it to "text/plain"
        String mimeType = "text/plain";
        // TODODONE (3) Create a title for the chooser window that will pop up
        String tittle = "Learning how to share content";
        // TODODONE (4) Use ShareCompat.IntentBuilder to build the Intent and start the chooser
