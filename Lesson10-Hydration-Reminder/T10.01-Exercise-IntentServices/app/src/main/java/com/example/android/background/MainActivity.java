...
public class MainActivity extends AppCompatActivity implements
    ...
    public void incrementWater(View view) {
        ...
        mToast.show();
        // TODODONE (15) Create an explicit intent for WaterReminderIntentService
        // TODODONE (16) Set the action of the intent to ACTION_INCREMENT_WATER_COUNT
        // TODODONE (17) Call startService and pass the explicit intent you just created
