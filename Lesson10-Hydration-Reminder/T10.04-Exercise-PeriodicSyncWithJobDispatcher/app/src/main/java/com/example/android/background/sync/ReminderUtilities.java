...
public class ReminderUtilities {
    // TODODONE (15) Create three constants and one variable:
    ...
    // TODODONE (16) Create a synchronized, public static method called scheduleChargingReminder that takes
    ...
    synchronized public static void scheduleChargingReminder(@NonNull final Context context){
        ...
        // TODODONE (17) If the job has already been initialized, return
        if(sInitialized) return;
        // TODODONE (18) Create a new GooglePlayDriver
        Driver driver = new GooglePlayDriver(context);
        // TODODONE (19) Create a new FirebaseJobDispatcher with the driver
        FirebaseJobDispatcher firebaseJobDispatcher = new FirebaseJobDispatcher(driver);
        // TODODONE (20) Use FirebaseJobDispatcher's newJobBuilder method to build a job which:
        ...
        // TODODONE (21) Use dispatcher's schedule method to schedule the job
        firebaseJobDispatcher.schedule(constraintReminderJob);
        // TODODONE (22) Set sInitialized to true to mark that we're done setting up the job
        sInitialized = true;
