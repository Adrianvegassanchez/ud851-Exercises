...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODODONE (5) Create and instantiate a new instance variable for your ChargingBroadcastReceiver
        // and an IntentFilter
        // TODODONE (6) Call the addAction method on your intent filter and add Intent.ACTION_POWER_CONNECTED
    ...
    // TODODONE (7) Override onResume and setup your broadcast receiver. Do this by calling
    ...
    // TODODONE (8) Override onPause and unregister your receiver using the unregisterReceiver method
    @Override
    ...
    // TODODONE (1) Create a new method called showCharging which takes a boolean. This method should
    ...
    // TODODONE (2) Create an inner class called ChargingBroadcastReceiver that extends BroadcastReceiver
        // TODODONE (3) Override onReceive to get the action from the intent and see if it matches the
        // Intent.ACTION_POWER_CONNECTED. If it matches, it's charging. If it doesn't match, it's not
        // charging.
        // TODODONE (4) Update the UI using the showCharging method you wrote
